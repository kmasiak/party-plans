...
def register():
    ...
    partydb = mysql.connector.connect(
        user='admin', password='Applesauce12', 
        host='database-project.cbh1cn1j4qvl.us-east-2.rds.amazonaws.com', 
...
# Calls themvoiedb api to retrieve the link to a movie poster image
